...
public class MainActivity extends AppCompatActivity {
    ...
    @ViewById(R.id.create_rental_item_button)
    FloatingActionButton createRentalItemButton;
    ...
    protected void pingTheServer() {
        try {
            ...
            createRentalItemButton.setEnabled(true);
    ...
    protected void onApiUnavailable() {
        createRentalItemButton.setEnabled(false);
